...
<main class="app-content">
  <div class="app-title">
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><a style="color:#001C40;" href="index.php?pg=qlsanpham">Quản lý sản phẩm</a>
      </li>
      ...
      <div class="tile">
        ...
        <form action="index.php?pg=addsp" enctype="multipart/form-data" method="post" class="row">
          ...
          <div class="form-group col-md-9">
            <label class="control-label">Ảnh sản phẩm<span style="color: red; font-weight: bold">(*)</span>
            </label>
            <div>
