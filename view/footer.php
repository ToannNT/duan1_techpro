                       ...
                       <div class="col-lg-2 col-md-3 col-sm-6">
                           <div class="footer-block">
                               ...
                               <ul>
                                   ...
                                   <li><a href="#">Gia nhập TOTODAY</a></li>
                               </ul>
                           </div>
                       </div>
               ...
               <div class="row">
                   <div class="col-lg-12">
                       ...
                       <div class="copyright text-center">
                           <a href="#">
                               <img src="./view/layout/images/payment/1.png" alt>
                           </a>
                       </div>
   ...
   <!-- Popper js -->
   <script src="./view/layout/asset/js/vendor/popper.min.js"></script>
   <!-- Bootstrap V4.1.3 Fremwork js -->
   <script src="./view/layout/asset/js/bootstrap.min.js"></script>
   <!-- Ajax Mail js -->
   <script src="./view/layout/asset/js/ajax-mail.js"></script>
   <!-- Meanmenu js -->
   <script src="./view/layout/asset/js/jquery.meanmenu.min.js"></script>
   <!-- Wow.min js -->
   <script src="./view/layout/asset/js/wow.min.js"></script>
   <!-- Slick Carousel js -->
   <script src="./view/layout/asset/js/slick.min.js"></script>
   <!-- Owl Carousel-2 js -->
   <script src="./view/layout/asset/js/owl.carousel.min.js"></script>
   <!-- Magnific popup js -->
   <script src="./view/layout/asset/js/jquery.magnific-popup.min.js"></script>
   <!-- Isotope js -->
   <script src="./view/layout/asset/js/isotope.pkgd.min.js"></script>
   <!-- Imagesloaded js -->
   <script src="./view/layout/asset/js/imagesloaded.pkgd.min.js"></script>
   <!-- Mixitup js -->
   <script src="./view/layout/asset/js/jquery.mixitup.min.js"></script>
   <!-- Countdown -->
   <script src="./view/layout/asset/js/jquery.countdown.min.js"></script>
   <!-- Counterup -->
   <script src="./view/layout/asset/js/jquery.counterup.min.js"></script>
   <!-- Waypoints -->
   <script src="./view/layout/asset/js/waypoints.min.js"></script>
   <!-- Barrating -->
   <script src="./view/layout/asset/js/jquery.barrating.min.js"></script>
   <!-- Jquery-ui -->
   <script src="./view/layout/asset/js/jquery-ui.min.js"></script>
   <!-- Venobox -->
   <script src="./view/layout/asset/js/venobox.min.js"></script>
   <!-- Nice Select js -->
