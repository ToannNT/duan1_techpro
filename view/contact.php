                    ...
                    <div class="col-lg-5 offset-lg-1 col-md-12 order-1 order-lg-2">
                        <div class="contact-page-side-content">
                            ...
                            <div class="single-contact-block">
                                <h4><i class="fa fa-fax" style="margin-right: 10px;"></i>Địa chỉ</h4>
                                <p>Công viên phần mềm Quang Trung, Quận 12, TP Hồ Chí Minh </p>
                            </div>
                            <div class="single-contact-block">
                                <h4><i class="fa fa-phone" style="margin-right: 10px;"></i> Số điện thoại</h4>
                                <p>SĐT: 0799526520</p>
                                <p>Đường dây nóng: 1009 678 456</p>
                            </div>
                            <div class="single-contact-block last-child">
                                <h4><i class="fa fa-envelope-o" style="margin-right: 10px;"></i> Email</h4>
