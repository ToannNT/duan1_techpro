                            ...
                            <div class="sidebar-categores-box">
                                ...
                                <div class="filter-sub-area">
                                    ...
                                    <div class="categori-checkbox">
                                        <form action="#">
                                            <ul>    
                                                <li><input type="checkbox" name="product-categori"><a href="#">Điện Thoại</a></li>
                                                <li><input type="checkbox" name="product-categori"><a href="#">Máy tính</a></li>
                                                <li><input type="checkbox" name="product-categori"><a href="#">Máy tính ảnh</a></li>
                                                <li><input type="checkbox" name="product-categori"><a href="#">Tai</a></li>
                                            </ul>
                                        </form>
                                    </div>
                                 </div>
