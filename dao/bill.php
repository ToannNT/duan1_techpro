...
{
    $sql = "INSERT INTO bill (ma_donhang,id_user ,ten_nguoidat,email_nguoidat,sdt_nguoidat,diachi_nguoidat, ten_nguoinhan,sdt_nguoinhan,diachi_nguoinhan,total,ship,vouncher,order_notes,tong,pttt,ngaydat,hoivien) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
